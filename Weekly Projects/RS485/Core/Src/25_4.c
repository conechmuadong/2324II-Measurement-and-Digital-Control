...
void sendData(uint8_t *data) {
	// enable TX for stm32 and RX for laptop
...
/*uint8_t recieveData() {
	// enable RX for stm32 and TX for laptop
	HAL_GPIO_WritePin(TX_en_GPIO_Port, TX_en_Pin, GPIO_PIN_RESET);
	HAL_GPIO_WritePin(RX_en_GPIO_Port, RX_en_Pin, GPIO_PIN_SET);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, TX_en_Pin|RX_en_Pin|GPIO_PIN_15, GPIO_PIN_RESET);

  /*Configure GPIO pins : TX_en_Pin RX_en_Pin PB15 */
  GPIO_InitStruct.Pin = TX_en_Pin|RX_en_Pin|GPIO_PIN_15;
